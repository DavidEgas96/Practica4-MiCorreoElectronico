...
<body>
    ...
    $contraUsuario = '@est.ups.edu.ec';
  /* echo $contraUsuario;

    $usuario2=$usuario;
   $comprobar1 = strtolower($usuario2);
   $comprobar = strpos($comprobar1, $contraUsuario);
 echo $comprobar1;*/
// $comprobar = strripos($usuario, $contraUsuario);
    //if($comprobar === true){
...
//}else {
 //   echo "El correo '$usuario' no es administrador";
//}
    ?>
</body>
